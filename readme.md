...
By default, the local setup will pick the openapi specification located at https://project-ii.ti.howest.be/monitor/apis/group-18.
...
## Production endpoints
 - H2 web client
   - https://project-ii.ti.howest.be/db-18
   - url: jdbc:h2:./db-18
   - username:group-18
   - password:see Leho for details.
 - Useful information
   - Server logs
     - https://project-ii.ti.howest.be/monitor/logs/group-18
   - Swagger Interface
     - https://project-ii.ti.howest.be/monitor/swagger/group-18
 ...
 - Sonar
   - https://sonar.ti.howest.be/dashboard?id=2022.project-ii%3Amars-server-18
   - https://sonar.ti.howest.be/dashboard?id=2022.project-ii%3Amars-client-18
